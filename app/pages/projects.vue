...
<template>
  <UDashboardPanel id="projects" class="!overflow-y-auto">
    ...
    <div class="relative group">
      ...
      <div
        v-else
        class="h-48 w-full bg-gradient-to-br from-primary-500 to-primary-700"
      />
    ...
    <div
      ...
      class="px-6 py-5 border-b border-zinc-200 dark:border-zinc-800"
    >
      <h3
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
        <div
          ...
          class="bg-white dark:bg-zinc-900 border border-emerald-200 dark:border-emerald-900/50 rounded-lg p-3 hover:border-emerald-500 transition cursor-pointer"
        >
          <span
            :class="[
              'inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold mb-2',
              getBadgeClasses(stat.category.color)
            ]"
          >
            {{ stat.category.name }}
          </span>
          <div class="flex items-baseline gap-2">
            ...
            <div class="text-xs text-muted">
              {{ ((stat.count / stats.total) * 100).toFixed(0) }}%
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Toolbar -->
    <div
      class="px-6 py-4 bg-white dark:bg-zinc-950 border-b border-zinc-200 dark:border-zinc-800 sticky top-0 z-10"
    >
      <!-- Bulk Actions Bar -->
      <div
