...
const handleBlur = () => {
  if (
    ...
    localColor.value !== props.property.color
  ) {
    saveChanges();
  }
};
...
<template>
  ...
  >
    <div
      class="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between bg-zinc-50/50 dark:bg-zinc-900/50"
    >
    ...
    <div class="p-4 space-y-5">
            ...
            <span
              ...
              :class="[
                localColor === color.value
                  ? 'opacity-100 dark:opacity-100 ring-2 ring-offset-2 ring-offset-white dark:ring-offset-zinc-900 ring-zinc-900 dark:ring-white'
                  : '',
                getSolidClass(color.value),
              ]"
            ></span>
            <!-- Solid Circle -->
            <span
              class="size-full rounded-full"
              :class="getSolidClass(color.value)"
            ></span>
      ...
      <div class="flex items-center justify-between pt-2">
        ...
        <div v-else class="flex items-center gap-2">
          ...
          <UButton color="error" size="xs" @click="handleDelete">
            Confirm
          </UButton>
        </div>
